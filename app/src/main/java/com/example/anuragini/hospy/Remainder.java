...
public class Remainder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Added Reminder");
        ...
        mNoReminderView.setTextColor(getResources().getColor(R.color.tabtextcolor));
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public  class VerticalItemHolder extends SwappingHolder
            ...
            public boolean onLongClick(View v) {
                AppCompatActivity activity = Remainder.this;
